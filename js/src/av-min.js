    ...
    t.exports = function (t) {
      t.User = t.Object.extend("_User", {
        ...
        authenticated: function () {
          return console.warn("DEPRECATED: Ã¥Â¦â€šÃ¦Å¾Å“Ã¨Â¦ÂÃ¥Ë†Â¤Ã¦â€“Â­Ã¥Â½â€œÃ¥â€°ÂÃ§â€Â¨Ã¦Ë†Â·Ã§Å¡â€žÃ§â„¢Â»Ã¥Â½â€¢Ã§Å Â¶Ã¦â‚¬ÂÃ¦ËœÂ¯Ã¥ÂÂ¦Ã¦Å“â€°Ã¦â€¢Ë†Ã¯Â¼Å’Ã¨Â¯Â·Ã¤Â½Â¿Ã§â€Â¨ currentUser.isAuthenticated().then()Ã¯Â¼Å’Ã¥Â¦â€šÃ¦Å¾Å“Ã¨Â¦ÂÃ¥Ë†Â¤Ã¦â€“Â­Ã¨Â¯Â¥Ã§â€Â¨Ã¦Ë†Â·Ã¦ËœÂ¯Ã¥ÂÂ¦Ã¦ËœÂ¯Ã¥Â½â€œÃ¥â€°ÂÃ§â„¢Â»Ã¥Â½â€¢Ã§â€Â¨Ã¦Ë†Â·Ã¯Â¼Å’Ã¨Â¯Â·Ã¤Â½Â¿Ã§â€Â¨ user.id === currentUser.idÃ£â‚¬â€š"), !!this._sessionToken && !t._config.disableCurrentUser && t.User.current() && t.User.current().id === this.id
        },
